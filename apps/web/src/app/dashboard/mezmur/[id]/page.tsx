    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 max-w-5xl mx-auto w-full">
      <div className="flex items-center justify-between mb-8">
        <Link href="/dashboard/mezmur">
          <Button
            variant="ghost"
            className="flex items-center gap-2 -ml-4 hover:bg-muted/50"
          >
        ...
        <div className="lg:col-span-3 space-y-8">
          <div>
            ...
            <div className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground">
              <p className="text-base leading-relaxed whitespace-pre-wrap">
                {mezmur.description ||
                  "No description provided for this mezmur."}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-6 border-t">
            <MetaItem
              icon={Tag}
              label="Category"
              value={mezmur.category?.name || "Unknown"}
            />
            <MetaItem
              icon={User}
              label="Uploaded By"
              value={mezmur.uploadedById}
            />
